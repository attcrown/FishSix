...
export default {
    ...
    methods: {
        ...
        delete_match() {           
            ...
            else if (this.editedItem.name_style.includes("Flip") && !this.editedItem.match_test) {
                db.ref(`hour_match/${this.editedItem.key_student}`).once("value", (snapshot) => {
                    const childData = snapshot.val();
                    db.ref(`hour_match/${keystudent.key_student}`).update({
                        hour: childData.hour - keystudent.hour,
            ...
            else if (this.editedItem.name_style.includes("Private") && !this.editedItem.match_test) {
                db.ref(`hour_match/${this.editedItem.key_student}`).once("value", (snapshot) => {
                    const childData = snapshot.val();
                    db.ref(`hour_match/${keystudent.key_student}`).update({
