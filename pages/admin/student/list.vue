    ...
    data() {
        return {
            ...
            headers: [
                ...
                { text: 'จำนวนชั่วโมง Flip Class ที่เหลือ ', value: 'stu.hourLeft', sortable: true },
                { text: 'จำนวนชั่วโมง Private Class ที่เหลือ ', value: 'stu.privateHourLeft', sortable: true },
